		...
		public void UpdateResourcesPath() {
			...
			case GenderType.Male:
				...
				case CharacterType.Goblin:
					...
					characterMaterial = "Character_goblin_male";
					break;
				case CharacterType.Orc:
					resourcesPath = "Orc_male/";
					characterMaterial = "Character_orc_male";
					break;
				case CharacterType.DarkElf:
					resourcesPath = "DarkElf_male/";
					characterMaterial = "Character_darkelf_male";
					break;
			...
			case GenderType.Female:
				...
				case CharacterType.Goblin:
					...
					characterMaterial = "Character_goblin_female";
					break;
				case CharacterType.Orc:
					resourcesPath = "Orc_female/";
					characterMaterial = "Character_orc_female";
					break;
				case CharacterType.DarkElf:
					resourcesPath = "DarkElf_female/";
					characterMaterial = "Character_darkelf_female";
					break;
				case CharacterType.Human:
