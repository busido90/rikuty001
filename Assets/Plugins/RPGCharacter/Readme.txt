...
In the dmeo, we use the rpgcharacter_skin prefab, and a method of instantiating and destroying
...
For further information please adhere to the ReadmeCombineSkinnedMeshes file.
