...
namespace LylekGames.RPGCharacter {
	[CustomEditor(typeof(CombineSkinMeshesTextureAtlas))]
	public class CombineSkinMeshesTextureAtlasEditor : Editor {
		CombineSkinMeshesTextureAtlas myCombine;

		public void OnEnable() {
			if (Application.isPlaying == false) {
				myCombine = (CombineSkinMeshesTextureAtlas)target;
		...
		public void SaveMeshData() {
			...
			SaveTexture(myCombine.specularAtlas, "_specular");
			//SAVE MATERIAL
